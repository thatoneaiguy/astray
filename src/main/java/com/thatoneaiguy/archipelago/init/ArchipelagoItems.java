...
public class ArchipelagoItems {
    ...
    public static final Item FORTNITE_EVENT_ITEM = registerItem("fortnite_event_item", new FortniteEventItem(new FabricItemSettings().rarity(Rarity.EPIC).fireproof()));
    public static final Item RUPTURE_EVENT_ITEM = registerItem("rupture_event_item", new FortniteEventItem(new FabricItemSettings().rarity(Rarity.EPIC).fireproof()));
    ...
    public static final Item JAR = registerItem("jar", new JarItem(new FabricItemSettings().rarity(Rarity.RARE)));

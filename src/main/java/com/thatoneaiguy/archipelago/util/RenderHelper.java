...
public final class RenderHelper {
    ...
    public static Shader getShader(RenderLayer type) {
        if (type instanceof net.minecraft.client.render.RenderLayer.MultiPhase compositeRenderType) {
    ...
    public static Vec2f worldPosToTexCoord(Vec3f worldPos, MatrixStack viewModelStack) {
        Matrix4f viewMat = viewModelStack.peek().getPositionMatrix(); // guess? this used to be viewModelStack.peek().getModel();

...
import static com.thatoneaiguy.archipelago.Archipelago.MODID;
...
public final class DataHelper {
    ...
    public static Vec3d randPos(BlockPos pos, net.minecraft.util.math.random.Random rand, double min, double max) {
